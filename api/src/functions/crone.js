...
function typeLabel(type){return({journal:'Journal',moon:'Moon Journal',kitchen:'Kitchen',apothecary:'Apothecary',crystals:'Crystals',tarot:'Tarot',dreams:'Dreams',spells:'Spells',grimoireRecipes:'Grimoire Recipes',signs:'Signs & Symbols',plant:'Plants',seasonal:'Seasonal Garden',projects:'Garden Projects',harvest:'Harvest & Use'})[type]||type}
