...
const definitions = {
  ...
  maintenance: { dir: 'house/maintenance/entries', datedTitle: true, bodyField: 'body', required: ['title', 'date', 'area', 'work_type', 'body'] },
...
function typeLabel(type){return({journal:'Journal',moon:'Moon Journal',kitchen:'Kitchen',maintenance:'House Maintenance',crystals:'Crystals',tarot:'Tarot',dreams:'Dreams',spells:'Spells',grimoireRecipes:'Grimoire Recipes',signs:'Signs & Symbols',plant:'Plants',seasonal:'Seasonal Garden',projects:'Garden Projects'})[type]||type}
